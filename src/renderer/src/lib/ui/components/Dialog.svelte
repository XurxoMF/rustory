...
<Dialog.Root bind:open {...restProps}>
  <Dialog.Portal to="#portal">
    ...
    <Dialog.Content
      class={[
        'absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-100 max-w-full h-fit max-h-full rounded-md shadow-xl outline-none transition-all @container',
        'inset-ring-2',
