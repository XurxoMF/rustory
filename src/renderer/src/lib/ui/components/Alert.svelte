...
<Dialog.Root bind:open {...restProps}>
  <Dialog.Portal to="#portal">
    ...
    <Dialog.Content
      class={[
        'absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-100 w-1/4 h-fit max-h-screen flex flex-col gap-8 p-8 rounded-md shadow-xl outline-none transition-colors @container',
