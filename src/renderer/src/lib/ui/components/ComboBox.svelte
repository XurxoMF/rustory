<script lang="ts" module>
  ...
  export const COMBOBOX_INPUT_MODE_CLASSES: Record<ComboBoxModes, string[]> = {
    neutral: [
      ...
      'bg-zinc-800/50 not-data-disabled:hover:bg-zinc-800/70 inset-ring-zinc-800 ring-zinc-800',
      't-light:bg-zinc-300/50 t-light:not-data-disabled:hover:bg-zinc-300/70 t-light:inset-ring-zinc-300 t-light:ring-zinc-300'
    ],
    info: [
      'inset-ring-2 focus-visible:not-read-only:inset-ring-1 focus-visible:not-read-only:ring-2',
      'text-blue-500 not-data-disabled:hover:text-blue-200 bg-blue-800/30 not-data-disabled:hover:bg-blue-800/70 inset-ring-blue-800 ring-blue-800',
      't-light:text-blue-500 t-light:not-data-disabled:hover:text-blue-800 t-light:bg-blue-300/30 t-light:not-data-disabled:hover:bg-blue-300/70 t-light:inset-ring-blue-300 t-light:ring-blue-300'
    ],
    success: [
      'inset-ring-2 focus-visible:not-read-only:inset-ring-1 focus-visible:not-read-only:ring-2',
      'text-green-500 not-data-disabled:hover:text-green-200 bg-green-800/30 not-data-disabled:hover:bg-green-800/70 inset-ring-green-800 ring-green-800',
      't-light:text-green-500 t-light:not-data-disabled:hover:text-green-800 t-light:bg-green-300/30 t-light:not-data-disabled:hover:bg-green-300/70 t-light:inset-ring-green-300 t-light:ring-green-300'
    ],
    warning: [
      'inset-ring-2 focus-visible:not-read-only:inset-ring-1 focus-visible:not-read-only:ring-2',
      'text-yellow-500 not-data-disabled:hover:text-yellow-200 bg-yellow-800/30 not-data-disabled:hover:bg-yellow-800/70 inset-ring-yellow-800 ring-yellow-800',
      't-light:text-yellow-500 t-light:not-data-disabled:hover:text-yellow-800 t-light:bg-yellow-300/30 t-light:not-data-disabled:hover:bg-yellow-300/70 t-light:inset-ring-yellow-300 t-light:ring-yellow-300'
    ],
    danger: [
      'inset-ring-2 focus-visible:not-read-only:inset-ring-1 focus-visible:not-read-only:ring-2',
      'text-red-500 not-data-disabled:hover:text-red-200 bg-red-800/30 not-data-disabled:hover:bg-red-800/70 inset-ring-red-800 ring-red-800',
      't-light:text-red-500 t-light:not-data-disabled:hover:text-red-800 t-light:bg-red-300/30 t-light:not-data-disabled:hover:bg-red-300/70 t-light:inset-ring-red-300 t-light:ring-red-300'
    ]
  } as const
  ...
  export const COMBOBOX_TRIGGER_MODE_CLASSES: Record<ComboBoxModes, string[]> = {
    neutral: [
      ...
      'not-data-disabled:hover:bg-zinc-800/70 inset-ring-zinc-800 ring-zinc-800',
      't-light:not-data-disabled:hover:bg-zinc-300/70 t-light:inset-ring-zinc-300 t-light:ring-zinc-300'
    ],
    info: [
      'focus-visible:inset-ring-1 focus-visible:ring-2',
      'text-blue-500 not-data-disabled:hover:text-blue-200 not-data-disabled:hover:bg-blue-800/70 inset-ring-blue-800 ring-blue-800',
      't-light:text-blue-500 t-light:not-data-disabled:hover:text-blue-800 t-light:bg-blue-300/30 t-light:not-data-disabled:hover:bg-blue-300/70 t-light:inset-ring-blue-300 t-light:ring-blue-300'
    ],
    success: [
      'focus-visible:inset-ring-1 focus-visible:ring-2',
      'text-green-500 not-data-disabled:hover:text-green-200 not-data-disabled:hover:bg-green-800/70 inset-ring-green-800 ring-green-800',
      't-light:text-green-500 t-light:not-data-disabled:hover:text-green-800 t-light:bg-green-300/30 t-light:not-data-disabled:hover:bg-green-300/70 t-light:inset-ring-green-300 t-light:ring-green-300'
    ],
    warning: [
      'focus-visible:inset-ring-1 focus-visible:ring-2',
      'text-yellow-500 not-data-disabled:hover:text-yellow-200 not-data-disabled:hover:bg-yellow-800/70 inset-ring-yellow-800 ring-yellow-800',
      't-light:text-yellow-500 t-light:not-data-disabled:hover:text-yellow-800 t-light:bg-yellow-300/30 t-light:not-data-disabled:hover:bg-yellow-300/70 t-light:inset-ring-yellow-300 t-light:ring-yellow-300'
    ],
    danger: [
      'focus-visible:inset-ring-1 focus-visible:ring-2',
      'text-red-500 not-data-disabled:hover:text-red-200 not-data-disabled:hover:bg-red-800/70 inset-ring-red-800 ring-red-800',
      't-light:text-red-500 t-light:not-data-disabled:hover:text-red-800 t-light:bg-red-300/30 t-light:not-data-disabled:hover:bg-red-300/70 t-light:inset-ring-red-300 t-light:ring-red-300'
    ]
  } as const
...
<Combobox.Root {items} bind:value={value as never} bind:open {allowDeselect} {...mergedRootProps}>
  <div class="relative w-full flex items-center">
    ...
    <Combobox.Trigger
      class={[
        'absolute right-0 shrink-0 min-w-10 min-h-10 flex items-center justify-center gap-2 p-2 rounded-sm outline-none',
