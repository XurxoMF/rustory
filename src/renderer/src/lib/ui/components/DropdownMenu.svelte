...
<DropdownMenu.Root bind:open {...restProps}>
  ...
  <DropdownMenu.Portal to="#portal">
    ...
    >
      ...
      <DropdownMenu.Arrow class={['transition-[color] duration-200', 't-dark:text-zinc-750', 't-light:text-zinc-300', 't-rust:text-rust-750', 't-midnight:text-gray-750']} {...arrowProps} />
    </DropdownMenu.Content>
  </DropdownMenu.Portal>
</DropdownMenu.Root>
