<script lang="ts">
  ...
  let { children, rounded = 'regular', size = 'regular', padding = 'text', ...restProps }: ButtonProps = $props()
</script>

<button
  class={[
    'w-fit flex items-center justify-center transition-[opacity] duration-200',
    'focus:outline-2',
