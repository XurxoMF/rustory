...
>
  <div
    class={['w-full h-full flex-1 rounded-full transition-[background-color, transform] duration-200', 't-dark:bg-zinc-750', 't-light:bg-zinc-400', 't-rust:bg-rust-750', 't-midnight:bg-gray-750']}
