...
{#if App.data.vsInstances.length === 0}
	<Empty.Root>
		<Empty.Header>
			...
			<Empty.Title>No Vintage Story Instances found!</Empty.Title>

			<Empty.Description>It looks like you've not created any Vintage Story Instances yet. Create one with the next button!</Empty.Description>
		</Empty.Header>

		<Empty.Content>
			<Button.Root variant="outline">
				<a href={resolve("/vs-instances/create")}> Create a Vintage Story Instance </a>
			</Button.Root>
		</Empty.Content>
	</Empty.Root>
{:else}
