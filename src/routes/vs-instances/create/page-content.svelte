<script lang="ts">
	...
	let version: RAPIVSVersion = $state(untrack(() => versions[0]));
...
<Typo.H1>Create a Vintage Story Instance</Typo.H1>
<Typo.Leading>Create a new Vintage Story Instance for your needs.</Typo.Leading>
			...
			<Field.Group>
				...
				<Field.Field data-invalid={dirErrors.length > 0}>
					...
					<div class="flex gap-2">
						...
						<Input.Root value={dir?.path || ""} placeholder="Select a directory..." readonly aria-invalid={dirErrors.length > 0} />
					</div>
